/**
 * app/borrowers/opengraph-image.tsx
 *
 * OG image for /borrowers  --  1200x630.
 * Branded gradient background with brand palette.
 * Text: og-cards.md /borrowers entry.
 */
...
export const alt         = "Draw working capital onchain | appeX Borrowers";
...
export default function Image(): ImageResponse {
  ...
  return new ImageResponse(
    (
      ...
      >
        {/* Base gradient */}
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(135deg, #050A18 0%, #0A0F1F 35%, #1A0A18 70%, #050A18 100%)" }} />
        ...
        <div
          style={{
            ...
            background: `radial-gradient(ellipse at center, rgba(195,168,174,0.25) 0%, transparent 65%)`,
          }}
        />
        ...
        >
          ...
          >
            Credit-reviewed borrowers draw USDC against verified receivables. Fees negotiated once. No ongoing covenants. No rate surprises.
          </div>
        </div>
