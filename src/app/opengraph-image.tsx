...
export const alt         = "appeX Protocol | Onchain Financing Infrastructure";
...
export default function Image(): ImageResponse {
  ...
  return new ImageResponse(
    (
      ...
      >
        {/* Base gradient */}
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(135deg, #050A18 0%, #0A0F1F 40%, #160930 70%, #0A0F1F 100%)" }} />
        ...
        <div
          style={{
            ...
            background: `radial-gradient(ellipse at center, rgba(90,28,203,0.40) 0%, transparent 65%)`,
          }}
        />
        ...
        >
          ...
          >
            Onchain Financing Infrastructure
          </div>
          ...
          >
            LPs deposit USDC. Approved borrowers draw capital against verified receivables. Fees accrue to NAV per advance.
          </div>
        </div>
