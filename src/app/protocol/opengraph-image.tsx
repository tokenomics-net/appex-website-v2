/**
 * app/protocol/opengraph-image.tsx
 *
 * OG image for /protocol  --  1200x630.
 * Branded gradient background with brand palette.
 * Text: og-cards.md /protocol entry.
 */
...
export const alt         = "How the appeX vault works | Protocol Mechanics";
...
export default function Image(): ImageResponse {
  ...
  return new ImageResponse(
    (
      ...
      >
        {/* Base gradient */}
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(135deg, #050A18 0%, #0A0F1F 30%, #1A0A3A 70%, #050A18 100%)" }} />
        ...
        <div
          style={{
            ...
            background: `radial-gradient(ellipse at center, rgba(90,28,203,0.45) 0%, transparent 65%)`,
          }}
        />
        ...
        >
          ...
          >
            Three steps: LPs deposit USDC, approved borrowers draw, fees accrue to NAV. Origination fees are one-time. No variable rates.
          </div>
        </div>
