 ...
 *
 * OG image for /about  --  1200x630.
 * Branded gradient background with brand palette.
 * Text: og-cards.md /about entry.
 */
...
export const alt         = "About appeX | A protocol, not a company";
...
export default function Image(): ImageResponse {
  ...
  return new ImageResponse(
    (
      ...
      >
        {/* Base gradient */}
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(135deg, #050A18 0%, #0A0F1F 30%, #120A30 70%, #050A18 100%)" }} />
        ...
        <div
          style={{
            ...
            background: `radial-gradient(ellipse at center, rgba(185,160,204,0.30) 0%, transparent 65%)`,
          }}
        />
        ...
        >
          ...
          >
            appeX is a decentralized protocol for onchain working capital. Mission, architecture, governance pathway, and security posture.
          </div>
        </div>
